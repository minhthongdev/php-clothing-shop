...
<body>
    ...
    if ($search) {
        $products = mysqli_query($con, "select * from sanpham where MALOAI = 3 AND `TENSP` LIKE '%" . $search . "%'  LIMIT " . $item_per_page . " OFFSET " . $offset . " ");
        $totalRecords = mysqli_query($con, "select * from sanpham where MALOAI = 3 AND `TENSP` LIKE '%" . $search . "%'");
    } else {
        $products = mysqli_query($con, "select * from sanpham where MALOAI = 3  LIMIT " . $item_per_page . " OFFSET " . $offset . " ");
